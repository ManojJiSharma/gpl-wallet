...
function createInstruction(nameProgramId, systemProgramId, nameKey, nameOwnerKey, payerKey, hashed_name, carats, space, nameClassKey, nameParent, nameParentOwner) {
    const buffers = [
