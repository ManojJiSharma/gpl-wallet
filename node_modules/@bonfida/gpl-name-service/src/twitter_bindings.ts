...
import { deleteNameRegistry, NAME_PROGRAM_ID } from "@bonfida/gpl-name-service/src/bindings";
import {
  createInstruction,
  deleteInstruction,
  transferInstruction,
  updateInstruction,
} from "@bonfida/gpl-name-service/src/instructions";
import { NameRegistryState } from "@bonfida/gpl-name-service/src/state";
import {
  ...
  Numberu32,
  Numberu64,
} from "@bonfida/gpl-name-service/src/utils";
