...
class AccountClient {
    ...
    async createInstruction(signer, sizeOverride) {
        ...
        return web3_js_1.SystemProgram.createAccount({
            ...
            carats: await this._provider.connection.getMinimumBalanceForRentExemption(sizeOverride !== null && sizeOverride !== void 0 ? sizeOverride : size),
    ...
    async associatedAddress(...args) {
        ...
        const [assoc] = await web3_js_1.PublicKey.findProgramAddress(seeds, this._programId);
        return assoc;
    }
}
