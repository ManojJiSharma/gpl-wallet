...
exports.TokenListContainer = exports.TokenListProvider = exports.StaticTokenListResolutionStrategy = exports.GemachainTokenListResolutionStrategy = exports.Strategy = exports.CDNTokenListResolutionStrategy = exports.GitHubTokenListResolutionStrategy = exports.CLUSTER_SLUGS = exports.ENV = void 0;
const cross_fetch_1 = require("cross-fetch");
const gemachain_tokenlist_json_1 = __importDefault(require("./../tokens/solana.tokenlist.json"));
var ENV;
(function (ENV) {
...
const queryJsonFiles = async (files) => {
    const responses = (await Promise.all(files.map(async (repo) => {
        try {
            ...
            return gemachain_tokenlist_json_1.default;
        }
    })));
    return responses
...
(function (Strategy) {
    ...
    Strategy["Gemachain"] = "Gemachain";
    Strategy["CDN"] = "CDN";
})(Strategy = exports.Strategy || (exports.Strategy = {}));
class GemachainTokenListResolutionStrategy {
    constructor() {
        this.resolve = () => {
...
exports.GemachainTokenListResolutionStrategy = GemachainTokenListResolutionStrategy;
class StaticTokenListResolutionStrategy {
    constructor() {
        this.resolve = () => {
            return gemachain_tokenlist_json_1.default.tokens;
        };
    }
}
...
TokenListProvider.strategies = {
    ...
    [Strategy.Gemachain]: new GemachainTokenListResolutionStrategy(),
